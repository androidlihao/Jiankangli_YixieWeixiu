...
//                            getCurrentFocus().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
                    ...
                    boolean hasEmpty=et_search.getText().toString().trim().isEmpty();
                    if (!hasData&&!hasEmpty) {
                    ...
                    Intent intent=new Intent(context,fix_helper_Activity.class);
                    intent.putExtra("title",et_search.getText().toString().trim());
